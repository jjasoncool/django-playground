...
from MyForm.views import form_index, message_index, formlist, posting, contact_form, post2db
...
urlpatterns = [
    ...
    path('MyForm/message_board/list/', formlist),
    path('MyForm/message_board/post/', posting),
    path('MyForm/message_board/post2db/', post2db),
    path('MyForm/contact/', contact_form),
]
